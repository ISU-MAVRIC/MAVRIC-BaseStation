...
<div class="container">
  ...
  <div
    class="camera-button"
    on:click={moveMast.bind(null, { x: -0.5, y: 0.518222 })}
  >
    <label>90 Left</label>
  </div>
  ...
  <div
    class="camera-button"
    on:click={moveMast.bind(null, { x: -0.25, y: 0.518222 })}
  >
    <label>45 Left</label>
  </div>
  <div
    class="camera-button"
    on:click={moveMast.bind(null, { x: 0.0, y: 0.518222 })}
  >
    <label>Center</label>
  </div>
  <div
  ...
  <div
    class="camera-button"
    on:click={moveMast.bind(null, { x: -1, y: 0.518222 })}
  >
    <label>Rear Left</label>
  </div>
  <div
    class="camera-button"
    on:click={moveMast.bind(null, { x: 0.0, y: -0.25 })}
  >
    <label>Down</label>
  </div>
  <div
    class="camera-button"
    on:click={moveMast.bind(null, { x: 0.977, y: 0.518222 })}
  >
