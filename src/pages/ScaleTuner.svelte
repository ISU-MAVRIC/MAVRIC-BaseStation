    ...
    <div class="scales-container">
      ...
      <div class="arm-tuner-container scales-column">
        <label for="shoulder-rotation-scale"
          >Shoulder Rotation Scale: {armScaleData.SHOULDER_ROTATION}</label
        >
        <input
          bind:value={armScaleData.SHOULDER_ROTATION}
          id="shoulder-rotation-scale"
          type="range"
          min={SCALES.ARM.SHOULDER_ROTATION.MIN}
          max={SCALES.ARM.SHOULDER_ROTATION.MAX}
          step={SCALES.ARM.SHOULDER_ROTATION.STEP}
        />
        ...
        <label for="wrist-rotation-scale"
          >Wrist Rotation Scale: {armScaleData.WRIST_ROTATION}</label
        >
        <input
          bind:value={armScaleData.WRIST_ROTATION}
          id="wrist-rotation-scale"
          type="range"
          min={SCALES.ARM.WRIST_ROTATION.MIN}
          max={SCALES.ARM.WRIST_ROTATION.MAX}
          step={SCALES.ARM.WRIST_ROTATION.STEP}
        />
